            ...
            <div className="w3-row-padding w3-padding-32 w3-border-bottom w3-border-light-grey">
                ...
                <div className="w3-col l9 m9 s12 w3-margin-bottom">
                    <div className="w3-display-container">
                        ...
                        <p className={css.news_paragraph}>Nick, Community Liaison Officer from Victoria Police, came to inspect our building for safety audit and discussed with some of our committee members and residents about security issues on 10/07/2019. He recommended measures for residents to take to increase the security of the building.</p>
