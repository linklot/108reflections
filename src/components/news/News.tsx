    ...
    <div className="w3-content w3-padding" style={maxWidthStyle}>
      ...
      <div className="w3-row-padding w3-padding-32 w3-border-bottom w3-border-light-grey">
        <div className="w3-col l3 m3 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <img
                src="./images/news/2025-02-17.jpg"
                alt="House"
                style={fullWidthStyle}
            />
            <div className={css.news_last_update}>Last updated: 18/02/2026</div>
          </div>
        </div>
        <div className="w3-col l9 m9 s12 w3-margin-bottom">
          <div className="w3-display-container">
            ...
            <p>
              Professional cleaning of common area carpets has been scheduled for Friday 20/02/2026.
            </p>
            <p>
      ...
      <div className="w3-row-padding w3-padding-32 w3-border-bottom w3-border-light-grey">
        <div className="w3-col l3 m3 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <img
                src="./images/news/2026-02-02.jpg"
                alt="House"
                style={fullWidthStyle}
            />
            <div className={css.news_last_update}>Last updated: 02/02/2026</div>
          </div>
        </div>
        <div className="w3-col l9 m9 s12 w3-margin-bottom">
          <div className="w3-display-container">
            ...
            <p>
              Building external window cleaning has been scheduled for from Monday 09/02/2026 to Thursday 12/02/2026 starting at 8am every day subject to weather conditions.
            </p>
            <p>
      ...
      <div className="w3-row-padding w3-padding-32 w3-border-bottom w3-border-light-grey">
        <div className="w3-col l3 m3 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <img
              src="./images/news/2025-12-02.jpg"
              alt="House"
              style={fullWidthStyle}
            />
            <div className={css.news_last_update}>Last updated: 02/12/2025</div>
          </div>
        </div>
        <div className="w3-col l9 m9 s12 w3-margin-bottom">
          <div className="w3-display-container">
            ...
            <p>
              Chute cleaning has been scheduled for <strong>Friday 05/12/2025 between 8:30am and 1pm</strong>.
            </p>
            <p>
      ...
      <div className="w3-row-padding w3-padding-32 w3-border-bottom w3-border-light-grey">
        <div className="w3-col l3 m3 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <img
              src="./images/news/2025-10-07.jpg"
              alt="House"
              style={fullWidthStyle}
            />
            <div className={css.news_last_update}>Last updated: 07/10/2025</div>
          </div>
        </div>
        <div className="w3-col l9 m9 s12 w3-margin-bottom">
          <div className="w3-display-container">
            ...
            <p>
              Subject to the weather conditions on the day, pest control treatment will be carried out on Monday 13/10/2025 between 9 am and 12:30 pm.
            </p>
            <p>
              Treatment Areas:
            </p>
            <p>
              <strong>Building perimeter, garden beds on Level 4, and Bin room areas in the car park.</strong>
            </p>
            <p>
        ...
        <div className="w3-col l3 m3 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <img
              ...
              style={fullWidthStyle}
            />
            <div className={css.news_last_update}>Last updated: 17/02/2025</div>
          </div>
        </div>
        <div className="w3-col l9 m9 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <h4 className={css.news_title}>Carpet Professional Cleaning</h4>
            <p>
              Professional cleaning of common area carpets has been scheduled for Friday 21/02/2025.
            </p>
            <p>
              Carpets in the corridors from Level 1 to Level 12 will be cleaned. Planned working hours are between 8 am and 3 pm.
            </p>
      ...
      <div className="w3-row-padding w3-padding-32 w3-border-bottom w3-border-light-grey">
        <div className="w3-col l3 m3 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <img
              src="./images/news/2025-01-07.jpg"
              alt="House"
              style={fullWidthStyle}
            />
            <div className={css.news_last_update}>Last updated: 07/01/2025</div>
          </div>
        </div>
        <div className="w3-col l9 m9 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <h4 className={css.news_title}>External Windows Cleaning</h4>
            <p>
              Building external window cleaning has been scheduled for from Monday 13/01/2025 to Thursday 16/01/2025 starting at 8am every day subject to weather conditions.
            </p>
            <p>
              Cleaning contractors will abseil down and clean the windows and balustrades starting on the southwest side of the building (facing Macaulay Rd), northwest side (facing neighbouring car park), northeast side (facing Shiel St), then southeast side (facing Haines St). The arrangements may be adjusted according to wind conditions.
            </p>
        ...
        <div className="w3-col l3 m3 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <img
              ...
              style={fullWidthStyle}
            />
            <div className={css.news_last_update}>Last updated: 18/12/2023</div>
          </div>
        </div>
        <div className="w3-col l9 m9 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <h4 className={css.news_title}>External Windows Cleaning</h4>
            <p>
              Building external window cleaning has been scheduled for from Monday 15/01/2024 to Thursday 18/01/2024 starting at 8am every day subject to weather conditions.
            </p>
            <p>
              Cleaning contractors will abseil down and clean the windows and balustrades starting on the southwest side of the building (facing Macaulay Rd), northwest side (facing neighbouring car park), northeast side (facing Shiel St), then southeast side (facing Haines St). The arrangements may be adjusted according to wind conditions.
            </p>
      ...
      <div className="w3-row-padding w3-padding-32 w3-border-bottom w3-border-light-grey">
        <div className="w3-col l3 m3 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <img
              src="./images/news/2023-11-13.jpg"
              alt="House"
              style={fullWidthStyle}
            />
            <div className={css.news_last_update}>Last updated: 13/11/2023</div>
          </div>
        </div>
        <div className="w3-col l9 m9 s12 w3-margin-bottom">
          <div className="w3-display-container">
            <h4 className={css.news_title}>Chute Cleaning</h4>
            <p>
              Chute cleaning has been scheduled for <strong>Friday 17/11/2023 between 8:30am and 2pm</strong>.
            </p>
            <p>
              Cleaners will access and work in chute rooms on all levels and the bin room on Ground Level.
            </p>
